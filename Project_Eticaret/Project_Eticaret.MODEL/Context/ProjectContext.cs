...
namespace Project_Eticaret.MODEL.Context
{
    public class ProjectContext : DbContext
    {
        ...
        {
            Database.Connection.ConnectionString = "Server=.; Database=Project_EticaretDB; uid=sa; pwd=123;";
        }

        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            // Hazırladığımız map sınıflarındaki konfigürasyonları da dahil ediyoruz.
